...
import com.angik.android.foodup_order.Model.SuperAdapter;
import com.angik.android.foodup_order.R;

import java.util.Objects;

public class SuperDetails extends AppCompatActivity implements SuperOrderFragment.OnFragmentInteractionListener, ItemStatusFragment.OnFragmentInteractionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle(getIntent().getStringExtra("store"));
        ...
        tabLayout.addTab(tabLayout.newTab().setText("Item Status"));
        ...
        final SuperAdapter adapter = new SuperAdapter(this, getSupportFragmentManager(), tabLayout.getTabCount());
