...
import com.angik.android.foodup_order.Model.MyAdapterKaftanLunch;
import com.angik.android.foodup_order.R;

import java.util.Objects;

public class SelectLunchActivityKaftan extends AppCompatActivity implements BiryaniFragment.OnFragmentInteractionListener,
        KhichuriFragment.OnFragmentInteractionListener, PolaoFragment.OnFragmentInteractionListener, RiceFragment.OnFragmentInteractionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_select_lunch_kaftan);
        ...
        tabLayout.addTab(tabLayout.newTab().setText("Khichuri"));
        ...
        final MyAdapterKaftanLunch adapter = new MyAdapterKaftanLunch(this, getSupportFragmentManager(), tabLayout.getTabCount());
