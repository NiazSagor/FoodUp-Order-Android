    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        markAsAvailable.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if (b) {
                    databaseReference.child("Roll").setValue("Roll");
                } else {
                    databaseReference.child("Roll").setValue(null);
                }
            }
        });
        ...
        mAdapter = new SelectionAdapter(getContext(), name, price, "Roll", "breakfast");
