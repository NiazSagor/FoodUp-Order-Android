 ...
 * {@link SelfPickUpFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link SelfPickUpFragment#newInstance} factory method to
...
public class SelfPickUpFragment extends Fragment {
    ...
    public static SelfPickUpFragment newInstance(String param1, String param2) {
        SelfPickUpFragment fragment = new SelfPickUpFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //TODO we have to change the node according to the current vendor
        View view = inflater.inflate(R.layout.fragment_self_pick_up, container, false);
